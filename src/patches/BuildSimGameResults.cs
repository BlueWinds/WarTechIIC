...
namespace WarTechIIC {
    ...
    public static class SimGameState_BuildSimGameResult_Patch {
        ...
        public static void Postfix(ref List<ResultDescriptionEntry> __result, ref SimGameEventResult[] resultsList, GameContext context) {
            var eventResultsCache = SimGameState_ApplySimGameEventResult_Patch.eventResultsCache;
            var results = combineResults(eventResultsCache);
        ...
        public static List<string> combineResults(List<(string, string)> eventResultsCache) {
            ...
            foreach (var (factionAction, location) in eventResultsCache) {
